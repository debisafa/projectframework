			...
			<div class="card">
				...
				<div class="card-body">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="matkul" class="form-control">
										<option value="">- Pilih -</option>
										<?php
										$matkul = mysqli_query($con, "SELECT * FROM tb_matkul ORDER BY id_matkul ASC");
										foreach ($matkul as $g) {
					...
					if (isset($_POST['save'])) {
						...
						$insert = mysqli_query($con, "INSERT INTO tb_ajar VALUES (NULL,'$kode','$hari','$waktu','$jamke','$guru','$matkul','$kelas','$semester','$ta' ) ");
