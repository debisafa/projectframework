            ...
            <tbody>
              ...
              foreach ($siswa as $g) { ?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')" href="?page=siswa&act=del&id=<?= $g['id_mahasiswa'] ?>"><i class="fas fa-trash"></i></a>
                    <a class="btn btn-info btn-sm" href="?page=siswa&act=edit&id=<?= $g['id_mahasiswa'] ?>"><i class="far fa-edit"></i></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
