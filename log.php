...
<head>
    ...
    <link rel="icon" href="assets/foto/icon.ico" type="image/x-icon" />
        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/foto/mts.png" alt="navbar brand" class="navbar-brand" width="40">
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-primary btn-block" type="submit"><i class="flaticon-up-arrow-2"></i>Masuk</button>
                                            <a href="../index.php" class="btn btn-danger btn-block"><i class="flaticon-back"></i>Kembali</a>
                                        </div>
                                    </form>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y'); ?> Presensi Mahasiswa.
                    </div>
                </div>
            </footer>
