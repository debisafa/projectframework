...
$mengajar = mysqli_query($con, "SELECT * FROM tb_ajar 
...
WHERE tb_ajar.id_dosen='$data[id_dosen]' AND tb_thajaran.status=1 ");
...
<head>
	...
	<title>Guru | Sistem Presensi</title>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="../assets/foto/user/<?= $data['foto'] ?>" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../assets/foto/user/<?= $data['foto'] ?>" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									foreach ($mengajar as $dm) { ?>
										<li>
											<a href="?page=absen&pelajaran=<?= $dm['id_ajar'] ?> ">
												<span class="sub-item">
						...
						<li class="nav-item">
							<div class="collapse" id="rekapAbsen">
								<ul class="nav nav-collapse">
									...
									foreach ($mengajar as $dm) { ?>
										<li>
											<a href="?page=rekap&pelajaran=<?= $dm['id_ajar'] ?> ">
												<span class="sub-item">
													<!-- <?= strtoupper($dm['matkul']); ?> -->KELAS (<?= strtoupper($dm['nama_kelas']); ?>)
												</span>
											</a>
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y'); ?> Presensi Universitas
					</div>
				</div>
			</footer>
		</div>
