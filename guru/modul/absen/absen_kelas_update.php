        ...
        <div class="col-md-8 col-xs-12">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <table>
                            ...
                            $siswa = mysqli_query($con, "SELECT * FROM _logabsensi INNER JOIN tb_mahasiswa ON _logabsensi.id_mahasiswa=tb_mahasiswa.id_mahasiswa WHERE  _logabsensi.tgl_absen='$tgl_hari_ini' AND _logabsensi.id_ajar='$_GET[pelajaran]' ORDER BY _logabsensi.id_mahasiswa ASC  ");
            ...
            if (isset($_POST['update'])) {
                ...
                for ($i = 0; $i <= $total; $i++) {
                    ...
                    $updte_absen = mysqli_query($con, "UPDATE _logabsensi SET ket='$ket' WHERE id_ajar='$pelajaran' AND id_mahasiswa='$id_mahasiswa' AND tgl_absen='$hari_sekarang' ");
